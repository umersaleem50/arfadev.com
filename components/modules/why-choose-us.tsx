...
function WhyChooseUs({ module }: any) {
  ...
  return (
    <section className="bg-none md:translate-y-1/4 md:-mt-16">
      <div className="max-w-[85rem] lg:py-24 md:py-16 sm:py-12 py-10 md:px-6 lg:px-0 lg:flex-row flex-col mx-auto bg-accent flex items-center shadow-md rounded-2xl">
