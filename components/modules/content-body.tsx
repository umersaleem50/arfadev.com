...
function ContentBody({ module }: { module: any; lightMode?: boolean }) {
  ...
  return (
    <section className="py-24">
      <article
        className={cn(
          "dark:text-foreground prose-headings:text-foreground prose-h1:leading-normal prose-strong:text-foreground prose-blockquote:text-foreground prose prose-blockquote:border-l-4 prose-blockquote:border-primary md:prose-base prose-headings:font-serif font-sans lg:prose-lg prose-stone !max-w-none !w-full col-start-1 col-span-8 mx-auto",
