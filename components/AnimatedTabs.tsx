...
export default function AnimatedTabs({
  ...
  const getTabStyles = (isActive: boolean) =>
    cn(
      "relative z-10 flex items-center justify-center gap-2 px-4 py-2 text-sm transition-colors font-sans",
  ...
  const getIndicatorStyles = () =>
    cn(
      ...
      variant === "pill" &&
        "inset-0 rounded-full border border-border bg-accent dark:bg-primary shadow-sm",
      variant === "segment" &&
